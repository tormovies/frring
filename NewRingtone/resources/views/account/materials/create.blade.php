...
<div class="page-header">
    <div class="container">
        <div class="page-header-content">
            <h1 class="page-title">Создать материал</h1>
        </div>
    </div>
</div>
...
<main class="main-cloud">
    <div class="container">
        <div style="max-width: 800px; margin: 2rem auto;">
            ...
            <form method="POST" action="{{ route('account.materials.store') }}" enctype="multipart/form-data" style="background: var(--bg-secondary); padding: 2rem; border-radius: 12px;">
                @csrf
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <textarea id="content" name="content" rows="15"
                                  ...
                                  style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 6px; background: var(--bg-primary); color: var(--text-primary); font-family: monospace; white-space: pre-wrap;">{{ old('content') }}</textarea>
                        <small style="color: var(--text-tertiary); font-size: 0.85rem;">Разрешены только буквы, цифры, точка, запятая, пробелы, скобки (), [], хештег #, !, ?</small>
                    </div>

                    <div style="margin-bottom: 1.5rem;">
                        <label for="mp4" style="display: block; margin-bottom: 0.5rem; font-weight: 500;">MP4 файл <span style="color: var(--text-danger);">*</span></label>
                        <input type="file" id="mp4" name="mp4" accept="audio/mp3,audio/mp4,audio/mpeg,audio/x-m4a" required
                               style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 6px; background: var(--bg-primary);">
                        <small style="color: var(--text-tertiary); font-size: 0.85rem;">Форматы: MP3, MP4, M4A. Максимум 10MB</small>
                    </div>
                </div>
                    ...
                    <div style="margin-top: 1.5rem;">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea id="seo_description" name="seo_description" rows="3"
                                      placeholder="Если не заполнено, будет использовано название"
                                      style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 6px; background: var(--bg-primary); color: var(--text-primary);">{{ old('seo_description') }}</textarea>
                        </div>

                        <div style="margin-bottom: 1.5rem;">
                            <label for="seo_h1" style="display: block; margin-bottom: 0.5rem; font-weight: 500;">H1</label>
                            <input type="text" id="seo_h1" name="seo_h1" value="{{ old('seo_h1') }}"
                                   placeholder="Если не заполнено, будет использовано название"
                                   style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 6px; background: var(--bg-primary); color: var(--text-primary);">
                        </div>
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea id="long_description" name="long_description" rows="5"
                                      style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 6px; background: var(--bg-primary); color: var(--text-primary);">{{ old('long_description') }}</textarea>
                        </div>
                    </div>
                </details>
